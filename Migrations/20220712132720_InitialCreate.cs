        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrdersForProductId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderProduct", x => new { x.OrderedProductsId, x.OrdersForProductId });
                    table.ForeignKey(
                        name: "FK_OrderProduct_order_OrdersForProductId",
                        column: x => x.OrdersForProductId,
